...
public class takeSafeCoinAction implements ActionListener {
    ...
    if (Controller.getInstance().checkNobat()) {
        if (!Controller.getInstance().checkCoins()) {
            ...
            Controller.getInstance().getStaticPlayer().takeSafeCoin();
        }
    }else {
        JOptionPane.showMessageDialog(null,"NOBATET NIST GOLAM");
    }
